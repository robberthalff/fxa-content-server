...
define(function (require, exports, module) {
  ...
  describe('views/settings/devices', function () {
    ...
    describe('refresh list behaviour', function () {
      ...
      it('does not call `_fetchDevices` using a notification if panel hidden ', function () {
        notifier.trigger(Notifier.DEVICE_REFRESH);
        assert.isFalse(view._fetchDevices.called);
      });
      ...
      it('calls `_fetchDevices` using a notification', function () {
        sinon.stub(view, 'isPanelOpen', function () {
          return true;
        });
